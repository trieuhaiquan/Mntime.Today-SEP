  ...
  <section class="wrapper" style="margin-top:0px;">
      ...
      <?php if(isset($_SESSION['errreport'])) echo $_SESSION['errreport'];?>    
                  ...
                  <div class="row mt">
                      ...
                      <div class="col-lg-12">
                          <div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i> Chart Report Time Used</h4>
