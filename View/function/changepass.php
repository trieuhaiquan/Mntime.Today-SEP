<div class="row" ng-app="">
    ...
    <div class="col-lg-12" >
        ...
        <form method="post" action='<?=BASE_DIR?>index/changepass2'>
            ...
            <span style="margin-left: 100px; font-weight: bolder">New Password: </span><input type="password" name="pass1" id="pass1" style="border-radius: 5px; margin: 0 0 10px 52px; width: 300px;" required ng-model="pass1" minlength="5"><br>
            <span style="margin-left: 100px; font-weight: bolder">Confirm New Password: </span><input type="password" name="pass2" id="pass2" style="border-radius: 5px; margin: 0 0 10px 20px; width: 300px;" required ng-model="pass2" minlength="5"><br>
